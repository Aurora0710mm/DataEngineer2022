...
# Three files contain information about (respectively) crashes, vehicles and participants. 
df_crash = df[df['Record Type'] == 1]
df_crash.to_csv("Crash.csv")

df_vehi = df[df['Record Type'] == 2]
df_vehi.to_csv("Vehicles.csv")

df_par = df[df['Record Type'] == 3]
df_par.to_csv("Participants.csv")